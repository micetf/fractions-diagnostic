 ...
 * Layout
 *
 * Intègre la navbar standard micetf.fr (fixe, dark gray, responsive)
 * avec le badge de mode enseignant/élève.
 *
 * @param {object}         props
 * @param {'teacher'|'student'} props.mode
 * @param {function}       props.onSwitchMode - Réservé (non exposé dans l'UI).
...
function Layout({ mode, children }) {
    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            {/* ── Contenu principal — offset navbar 56px ───────────────── */}
